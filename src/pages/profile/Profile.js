          ...
          <div className="card" data-state="#about">
            ...
            <div className="card-main">
              ...
              <div className="card-buttons">
                <button onClick={handleButtonClick} data-section="#about" className="is-active">
                  ABOUT
                </button>
                <button onClick={handleButtonClick} data-section="#experience">EXPERIENCE</button>
                <button onClick={handleButtonClick} data-section="#contact">CONTACT</button>
              </div>
            </div>
          </div>
        </div>
